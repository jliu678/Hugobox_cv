# Conjugate Priors: Bypassing Marginal Distributions in Bayesian Inference
...
Instead, we directly get the posterior parameters and use the known Beta normalization.
